...
//::END OF 'CONFIGURATION'
	...
	//dictionaries
	$dict_scholarships = $hnd->GetDiscountsByKey();
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Finance Administration &raquo; Discounts</span> 
							</h1>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='finance.php'" />
									<input type="button" value="Add Discount" onclick="window.location='finance-discount-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
									...
									<?php 
										...
										foreach($dict_scholarships as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<a href=\"finance-discount-edit.php?id={$item->discount_id}\">Edit</a>";
													echo " | ";
													echo "<a  onclick=\"return confirm('Continue deleting this discount? Click OK to continue.');\" href=\"finance-discount-process.php?id={$item->discount_id}&action=del\">Delete</a>";
													echo "</td>";
												echo "</tr>";
										}
										if($ctr==0){
