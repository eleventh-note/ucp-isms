...
//::END OF 'CONFIGURATION'
	...
	$college_types = $hnd->GetCollegeTypes();
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">College Administration &raquo; College Types</span> 
							</h1>
							<p class="">Below are the college types used to define colleges.</p>
							<div id="actions">
								<p class="action"><input type="button" value="Go Back" onclick="window.location='colleges.php'" /></p>
								<p class="action"><input type="button" value="Add College Type" onclick="window.location='colleges-type-add.php'" /></p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($success)){
							...
							?>
							<div class="table">
								<table class="colleges" cellspacing="0" title="">
									<thead>
										<th class="Count">No.</th>
										<th class="college_type">College Type</th>
										<th class="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
										if(sizeof($college_types) > 0){
											foreach($college_types as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<td class=\"Actions\">";
														echo "<a href=\"colleges-type-edit.php?id={$item->type_id}\">Edit</a>";
														echo " | ";
														echo "<a href=\"colleges-type-process.php?id={$item->type_id}&action=delete\" onclick=\"return confirm('Delete college type? Click OK to continue.')\">Delete</a>";
													echo "</td>";
												echo "</tr>";
											}
										} else {
											echo "<td colspan=\"6\">No employee record exists.</td>";
										}
									?>
