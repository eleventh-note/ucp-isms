			...
			<div id="body">
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Administration</span>
								<?php
									//##### PASS ERROR IF FOUND
									if(isset($success)){
							...
							<p class=""><b></b></p>
							<div id="actions">
								<p class="action"><input type="button" value="Application Status" onclick="window.location='students-application_status.php'" /></p>
								<p class="action"><input type="button" value="Application Type" onclick="window.location='students-application_type.php'" /></p>

								<p class="action"><input type="button" value="Student Status" onclick="window.location='students-status.php'" /></p>
								<p class="action"><input type="button" value="Preadmission Records" onclick="window.location='students-preadmission.php'" /></p>
								<p class="action"><input type="button" value="Student Permanent Records" onclick="window.location='students-spr.php'" /></p>
							</div>
						</div>
					</div>
				</div>
