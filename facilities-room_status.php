			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Facility Administration &raquo; Manage Room Status</span> 
							</h1>
							<p class="">The list of room status below are used to define rooms.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='facilities.php'" />
									<input type="button" value="Add Room Status" onclick="window.location='facilities-room_status-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
										...
										foreach($statuses as $item){
											...
											if($ctr % 2 == 0){
												...
												echo "<td class=\"Actions\">";
													echo "<a href=\"facilities-room_status-edit.php?id={$item->status_id}\">Edit</a>";
													echo " | ";
													echo "<a href=\"facilities-room_status-process.php?id={$item->status_id}&action=delete\" onclick=\"return confirm('Delete room status? Click OK to continue.')\">Delete</a>";
												echo "</td>";
											echo "</tr>";
										}
									?>
