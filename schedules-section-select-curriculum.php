			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Section & Schedule Administration &raquo; Sections &raquo; Select Curriculum</span>
							</h1>
							<p class="">Select curriculum below:</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
											<td>
												...
												redirectTo('schedules-section-select-semyear.php?cid=<?php echo $college_id; ?>&cud=<?php echo $course_id; ?>&cur=', getSelectValue('oSchoolYear')); } else { alert('Please select a cirruculum.') }" />
