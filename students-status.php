			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Administration &raquo; Student Status</span> 
							</h1>
							<p class="">Below are the statuses used to define students.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='students.php'" />
									<input type="button" value="Add Status" onclick="window.location='students-status-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="colleges" cellspacing="0" title="">
									<thead>
										...
										<th class="college_type">Student Status</th>
										<th class="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
											...
											foreach($statuses as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<td class=\"Actions\">";
														echo "<a href=\"students-status-edit.php?id={$item->status_id}\">Edit</a>";
														echo " | ";
														echo "<a href=\"students-status-process.php?id={$item->status_id}&action=delete\" onclick=\"return confirm('Delete student status? Click OK to continue.')\">Delete</a>";
													echo "</td>";
												echo "</tr>";
											}
										} else {
