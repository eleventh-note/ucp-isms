			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Enlistment &raquo; Search Student</span>
							</h1>
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
											<td>
												...
												<input type="button" class="button" name="cancel" value="Cancel" onclick="window.location='enlistment.php'" />
										...
										<?php 
											...
											if(sizeof($records) > 0){
												foreach($records as $item){
													...
													if($ctr % 2 == 0){
														echo "<tr class=\"even\" onclick=\"window.location='enlistment-view.php?id={$item->student_id}';\">";
													} else {
														echo "<tr class=\"odd\" onclick=\"window.location='enlistment-view.php?id={$item->student_id}';\">";
													}
														echo "<td>{$ctr}</td>";
