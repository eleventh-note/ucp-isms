			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information &raquo; Region Listing</span> 
							</h1>
							<p class="">Below are the regions recorded in the I-SMS.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='generalinfo.php'" />
									<input type="button" value="Add Region" onclick="window.location='generalinfo-region-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="countries default" cellspacing="0" title="">
									<thead>
										...
										<th class="medium_width">Region Description</th>
										<th class="small_width">Region Code</th>
										<th class="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
											...
											foreach($regions as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<td class=\"Actions\">";
														echo "<a href=\"generalinfo-region-edit.php?id={$item->region_id}\">Edit</a>";
														echo " | ";
														echo "<a href=\"generalinfo-region-process.php?id={$item->region_id}&action=delete\" onclick=\"return confirm('Delete region from records? Click OK to continue.')\">Delete</a>";
													echo "</td>";
												echo "</tr>";
											}
										} else {
											echo "<td colspan=\"6\">There are no regions registered.</td>";
										}
									?>
