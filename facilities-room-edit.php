...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		if(sizeof($rooms) > 0){
			...
			$code = $room->code;
			$floor = $room->floor;
			$_building = $room->building->building_id;
			$_type = $room->type->type_id;
			$_status = $room->status->status_id;
			$seating_capacity = $room->seating_capacity;
			
		} else {
			$_SESSION['error'] = array("Unknown room.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Facility Administration &raquo; Manage Rooms &raquo; Edit Details</span> 
							</h1>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="room_save" value="Save Details" />
											</td>
										</tr>
									</table>
								</div>
