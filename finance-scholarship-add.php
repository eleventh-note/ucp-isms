			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Finance Administration &raquo; Scholarships &raquo; Add</span> 
							</h1>
							...
							?>
							<form action="finance-scholarship-process.php" method="post">
								<hr class="form_top"/>
								<div class="table_form">
									<table class="form" cellspacing="0">
										...
										<tr>
											...
											<td class="input">: <input type="text" name="percentage" class="input_position" /></td>
										</tr>
										<tr>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='finance-scholarship.php';"/>
												<input type="submit" class="button" name="scholarship_save" value="Add" />
											</td>
										</tr>
									</table>
								</div>
