...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		$code = $college->code;
		$_college_type = $college->college_type[0]->type_id;
		$_division = $college->division[0]->division_id;
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">College Administration &raquo; Edit College Information</span> 
							</h1>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="college_save" value="Save" />
											</td>
										</tr>
									</table>
								</div>
