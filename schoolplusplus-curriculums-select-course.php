...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['cid'])){
		...
		if(sizeof($colleges) > 0){
			...
			if(sizeof($courses) == 0){
				$_SESSION['error'] = array("College selected has no courses defined.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Curriculum Administration &raquo; Curriculum &raquo; Select Course</span>
							</h1>
							<p class="">Select a course below:</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
								...
								<div class="table_form">
									<table class="form" cellspacing="0">
										...
										<tr class="info">
											...
											<td class="input">: 
												<select id="oCourse" class="large" name="course">
									...
									<table class="form" cellspacing="0">
											<td>
												<input type="button" class="button" value="Back" onclick="window.location='schoolplusplus-curriculums-select-college.php';"/>
												<input type="button" class="button"  value="Next" onclick="if(getSelectValue('oCourse') > 0){
												
												redirectTo('schoolplusplus-curriculums-select-sy.php?cid=<?php echo $college_id; ?>&cud=', getSelectValue('oCourse'));
