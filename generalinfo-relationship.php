...
//::END OF 'CONFIGURATION'
	...
	$relationships = $hnd->GetRelationships();
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information &raquo; Relationship Listing</span> 
							</h1>
							<p class="">Below are the list of relationships used in the I-SMS.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='generalinfo.php'" />
									<input type="button" value="Add Relationship" onclick="window.location='generalinfo-relationship-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="countries default" cellspacing="0" title="">
									<thead>
										...
										<th class="medium_width">Relationship</th>
										<th class="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
											...
											foreach($relationships as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<td class=\"Actions\">";
														echo "<a href=\"generalinfo-relationship-edit.php?id={$item->relationship_id}\">Edit</a>";
														echo " | ";
														echo "<a href=\"generalinfo-relationship-process.php?id={$item->relationship_id}&action=delete\" onclick=\"return confirm('Delete relationship from records? Click OK to continue.')\">Delete</a>";
													echo "</td>";
												echo "</tr>";
											}
										} else {
											echo "<td colspan=\"6\">There are no relationships registered.</td>";
										}
									?>
