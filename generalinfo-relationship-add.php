			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information &raquo; Relationship Listing &raquo; Add Relationship</span> 
							</h1>
							<p class="">Input new relationship.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="relationship_save" value="Add Relationship" />
											</td>
										</tr>
									</table>
								</div>
