			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Employee Administration &raquo; Manage Positions</span> 
							</h1>
							<p class="">The list of positions below will be used to define employees.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='employment.php'" />
									<input type="button" value="Add Position" onclick="window.location='employment-position-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="positions" cellspacing="0" title="">
									<thead>
										<th id="Count">No.</th>
										<th id="Position">Employee Position</th>
										<th id="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
										foreach($positions as $item){
											...
											if($ctr % 2 == 0){
												...
												echo "<td class=\"Actions\">";
													echo "<a href=\"employment-position-edit.php?id={$item->position_id}\">Edit</a>";
													echo " | ";
													echo "<a href=\"employment-position-process.php?id={$item->position_id}&action=delete\" onclick=\"return confirm('Delete position? Click OK to continue.')\">Delete</a>";
												echo "</td>";
											echo "</tr>";
										}
									?>
