...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		$id = (int) $_GET['id'];
		$statuses = $hnd->GetApplicationStatuses($id);
		
		if(sizeof($statuses) == 0){
			$_SESSION['error'] = array("Unknown application status status.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Administration &raquo; Application Status &raquo; Edit Status</span> 
							</h1>
							<p class="">Input new description of application status '<b><?php echo $statuses[0]->description; ?></b>' below.</p>
							<?php
								//#	#### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="students-application_status-process.php" method="post">
								<input type="hidden" name="id" value="<?php echo $statuses[0]->status_id; ?>" />
								<hr class="form_top"/>
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Application Status</td>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='students-application_status.php';"/>
