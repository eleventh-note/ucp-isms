			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Faculty Administration &raquo; Manage Faculty Status</span> 
							</h1>
							<p class="">The list of faculty status below will be used to define faculties.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='employment.php'" />
									<input type="button" value="Add Faculty Status" onclick="window.location='employment-faculty_status-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="positions" cellspacing="0" title="">
									<thead>
										<th id="Count">No.</th>
										<th id="Position">Faculty Status</th>
										<th id="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
										foreach($statuses as $item){
											...
											if($ctr % 2 == 0){
												...
												echo "<td class=\"Actions\">";
													echo "<a href=\"employment-faculty_status-edit.php?id={$item->status_id}\">Edit</a>";
													echo " | ";
													echo "<a href=\"employment-faculty_status-process.php?id={$item->status_id}&action=delete\" onclick=\"return confirm('Delete faculty status? Click OK to continue.')\">Delete</a>";
												echo "</td>";
											echo "</tr>";
										}
									?>
