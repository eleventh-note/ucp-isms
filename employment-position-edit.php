			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Employee Administration &raquo; Manage Positions &raquo; Edit</span> 
							</h1>
							<p class="">Input new description for position '<b><?php echo $position->description; ?></b>' below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="employment-position-process.php" method="post">
								<?php echo "<input type=\"hidden\" name=\"id\" value=\"{$position->position_id}\" />"; ?>
								<hr class="form_top"/>
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Position Description</td>
											<td class="input">: <input type="text" name="position" class="input_position" /></td>
										</tr>
									</table>						
									<hr class="form_top"/>
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='employment-position.php';"/>
												<input type="submit" class="button" name="position_save" value="Save" />
											</td>
										</tr>
									</table>
								</div>
