	...
	if(isset($_GET['id'])){
		...
		if($id <= 0){
			...
			if(sizeof($employees) == 0){
				...
				$sss = $employee->sss;
				$sss = explode("-", $sss);
				if(sizeof($sss) == 3){ $sss_1 = $sss[0]; $sss_2 = $sss[1]; $sss_3 = $sss[2]; }
				$tax = $employee->tin;
				$tax = explode("-", $tax);
				if(sizeof($tax) == 4){ $tax_1 = $tax[0]; $tax_2 = $tax[1]; $tax_3 = $tax[2]; $tax_4 = $tax[3]; }
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Employee Administration &raquo; Manage Employees &raquo; Edit Information</span> 
							</h1>
							...
							<form action="employment-employee-process.php" method="post">
								...
								<div class="table_form">
									...
									<table class="form employee" cellspacing="0">
										...
										<tr class="input">
											<td><input type="text" name="employee_number" class="input_employee_number" value="<?php echo $employee_number; ?>"/></td>
											<td></td>
											<td></td>
											<td></td>
										</tr>
									...
									<div id="educational_attainment">
										...
										<table class="form employee" cellspacing="0">
											...
											<tr class="input">
												...
												<td><input type="text" name="educ_year" class="input_year" value="<?php if(isset($educ_year)){ if($educ_year > 0){ echo $educ_year; }}?>"/></td>
											</tr>
										</table>
									</div>
									<hr class="form_top"/>
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='employment-employee-view.php?id=<?php echo $id; ?>';"/>
												<input type="submit" class="button" name="employee_save" value="Save Information" />
											</td>
										</tr>
									</table>
								</div>
