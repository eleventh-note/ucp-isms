				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							...
							<p class="">The list of school fees below is assigned to subjects during creation of subjects.</p>
							<div id="actions">
								<p class="action">
							...
							<div class="table">
								<table class="positions" cellspacing="0" title="">
									...
									<?php 
										...
										foreach($fees as $item){
											if($item->is_virtual == 1){
												...
												if($ctr % 2 == 0){
													...
													echo "<td>{$dict_fee_types[$item->fee_type]->description}</td>";
										...
										if($ctr==0){
											echo "<tr><td colspan=\"5\">No school fees defined.</td></tr>";
										}
									?>
