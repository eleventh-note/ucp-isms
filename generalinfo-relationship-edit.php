...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		$id = (int) $_GET['id'];
		$relationships = $hnd->GetRelationships($id);
		
		if(sizeof($relationships) == 0){
			$_SESSION['error'] = array("Unknown relationship.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information &raquo; Relationship Listing &raquo; Edit Relationship</span> 
							</h1>
							<p class="">Input new details for '<b><?php echo $relationships[0]->description; ?></b>' below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="generalinfo-relationship-process.php" method="post">
								<input type="hidden" name="id" value="<?php echo $relationships[0]->relationship_id; ?>" />
								<hr class="form_top"/>
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='generalinfo-relationship.php';"/>
												<input type="submit" class="button" name="relationship_save" value="Save Information" />
											</td>
										</tr>
									</table>
								</div>
