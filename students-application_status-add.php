			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Administration &raquo; Application Status &raquo; Add Status</span> 
							</h1>
							<p class="">Input description of application status below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="status_save" value="Add Status" />
											</td>
										</tr>
									</table>
								</div>
