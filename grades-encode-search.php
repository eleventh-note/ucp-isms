			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Grades Administration &raquo; Encoding &raquo; Search Student</span>
							</h1>
										...
										<?php 
											...
											if(sizeof($records) > 0){
												foreach($records as $item){
													...
													if($ctr % 2 == 0){
														echo "<tr class=\"even\" onclick=\"window.location='grades-encode.php?id={$item->student_id}';\">";
													} else {
														echo "<tr class=\"odd\" onclick=\"window.location='grades-encode.php?id={$item->student_id}';\">";
													}
														echo "<td>{$ctr}</td>";
