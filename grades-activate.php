			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Grades Administration &raquo; Activate Encoding</span> 
								<?php
									//##### PASS ERROR IF FOUND
									if(isset($success)){
							...
							<p class=""><b></b></p>
							<div id="actions">
								<p class="action"><input type="button" value="Go Back" onclick="window.location='grades.php'" /></p>
								<p class="action"><input type="button" value="Activate Grading Period" onclick="window.location='grades-activate-period.php'" /> - Activate encoding for selected grading period.</p>
								<!--
								<p class="action"><input type="button" value="Activate Specific" onclick="window.location='grades-encode-search.php'" /> - </p>
								<p class="action"><input type="button" value="View Active Encoders" onclick="window.location='grades-viewer-search.php'" /> - </p>
								-->
							</div>
						</div>
					</div>
