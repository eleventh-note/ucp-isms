...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		//get ranks array
		$ranks = $hnd->GetFacultyRanks($id);
		$rank = $ranks[0];		
	} else {
		$_SESSION['error'] = array("Faculty Rank not found.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Faculty Administration &raquo; Manage Faculty Ranks &raquo; Edit</span> 
							</h1>
							<p class="">Input new description for faculty rank '<b><?php echo $rank->description; ?></b>' below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="employment-faculty_rank-process.php" method="post">
								<?php echo "<input type=\"hidden\" name=\"id\" value=\"{$rank->rank_id}\" />"; ?>
								<hr class="form_top"/>
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Faculty Rank Description</td>
											<td class="input">: <input type="text" name="rank" class="input_rank" /></td>
										</tr>
									</table>						
									<hr class="form_top"/>
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='employment-faculty_rank.php';"/>
												<input type="submit" class="button" name="rank_save" value="Save" />
											</td>
										</tr>
									</table>
								</div>
