						...
						<div class="inner">
							...
							<div id="actions">
								<p class="action">
									...
									<input type="button" value="Add Payments" onclick="window.location='finance-student_payments-search.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
									...
									<?php 
										...
										foreach($payments as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<a target=\"_blank\" href=\"finance-payment_history-get_receipt.php?id={$item['transaction_no']}&sid={$item['student_id']}&tid=7\">Get Receipt</a> | ";
													echo "<a onclick=\"return confirm('Continue deleting this payment? Click OK to continue.');\" href=\"finance-payment_history-process.php?id={$item['payment_id']}&action=del\">Delete</a>";
													echo "</td>";
												echo "</tr>";
										}
										if($ctr==0){
