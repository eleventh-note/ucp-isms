...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		$id = (int) $_GET['id'];
		$types = $hnd->GetApplicationTypes($id);
		
		if(sizeof($types) == 0){
			$_SESSION['error'] = array("Unknown application type.");
			header("Location: students-application_types.php");
			exit();		
		}
	} else {
		$_SESSION['error'] = array("Unknown application type.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Administration &raquo; Application Types &raquo; Edit Type</span> 
							</h1>
							<p class="">Input new description of application type '<b><?php echo $types[0]->description; ?></b>' below.</p>
							<?php
								//#	#### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="students-application_type-process.php" method="post">
								<input type="hidden" name="id" value="<?php echo $types[0]->type_id; ?>" />
								<hr class="form_top"/>
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Application Type</td>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='students-application_type.php';"/>
												<input type="submit" class="button" name="type_save" value="Save Type" />
											</td>
										</tr>
									</table>
								</div>
