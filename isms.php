			...
			<div id="body">
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								Welcome to the <span class="School_Name"><?php echo SCHOOL_NAME; ?></span> I-SMS
							</h1>
							<p>The Integrated School Management System (ISMS) is built to enhance the way educational institutions handle their student records. Please feel free to contact the developers for comments and suggestions.</p>
						</div>
					</div>
				</div>
				<div class="clear"></div>
