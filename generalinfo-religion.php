			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information &raquo; Religion Listing</span> 
							</h1>
							<p class="">Below are the list of religions used in the I-SMS.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='generalinfo.php'" />
									<input type="button" value="Add Religion" onclick="window.location='generalinfo-religion-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="countries default" cellspacing="0" title="">
									<thead>
										...
										<th class="medium_width">Religion</th>
										<th class="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
											...
											foreach($religions as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<td class=\"Actions\">";
														echo "<a href=\"generalinfo-religion-edit.php?id={$item->religion_id}\">Edit</a>";
														echo " | ";
														echo "<a href=\"generalinfo-religion-process.php?id={$item->religion_id}&action=delete\" onclick=\"return confirm('Delete religion from records? Click OK to continue.')\">Delete</a>";
													echo "</td>";
												echo "</tr>";
											}
										} else {
											echo "<td colspan=\"6\">There are no religions registered.</td>";
										}
									?>
