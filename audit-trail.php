...
//::END OF 'CONFIGURATION'
	...
	if(isset($_SESSION['UserInfo'])){
		...
		$PagePrivileges->AddPrivilege("School Owner");
								...
								<?php
									...
									foreach($trails as $trail){	
										...
										if($ctr % 2 == 0){
											...
											echo "<td style=\"vertical-align: top\">{$trail['Username']}</td>";
											echo "<td style=\"vertical-align: top\">{$trail['tableName']}</td>";
											echo "<td style=\"vertical-align: top\">{$trail['action']}</td>";
											echo "<td style=\"vertical-align: top\">{$trail['newValue']}</td>";
											echo "<td style=\"vertical-align: top\">{$trail['dateCreated']}</td>";
										echo "</tr>";
									}
								?>
								</table>
