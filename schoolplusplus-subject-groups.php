			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Subject Administration &raquo; Subject Groups</span> 
							</h1>
							<p class="">The list of subject groups below will be used to define subjects.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='schoolplusplus.php'" />
									<input type="button" value="Add Group" onclick="window.location='schoolplusplus-subject-groups-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="positions" cellspacing="0" title="">
									<thead>
										<th id="Count">No.</th>
										<th id="Position">Subject Groups</th>
										<th id="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
										foreach($groups as $item){
											...
											if($ctr % 2 == 0){
												...
												echo "<td class=\"Actions\">";
													echo "<a href=\"schoolplusplus-subject-groups-edit.php?id={$item->group_id}\">Edit</a>";
													echo " | ";
													echo "<a href=\"schoolplusplus-subject-groups-edit.php?id={$item->group_id}&action=delete\" onclick=\"return confirm('Delete subject group? Click OK to continue.')\">Delete</a>";
												echo "</td>";
											echo "</tr>";
										}
									?>
