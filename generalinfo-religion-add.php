			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information &raquo; Religion Listing &raquo; Add Religion</span> 
							</h1>
							<p class="">Input new religion.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="religion_save" value="Add Religion" />
											</td>
										</tr>
									</table>
								</div>
