			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Grades Administration</span> 
								<?php
									//##### PASS ERROR IF FOUND
									if(isset($success)){
							...
							<p class=""><b></b></p>
							<div id="actions">
								<p class="action"><input type="button" value="Activate Encoding" onclick="window.location='grades-activate.php'" /> - Enable encoding of grades.</p>
								<p class="action"><input type="button" value="Encode Grades" onclick="window.location='grades-encode-subject_list.php'" /> - View subjects that are open for encoding grades.</p>
								<p class="action"><input type="button" value="View Current Grades" onclick="window.location='grades-viewer-search.php'" /> - View grades for the current semester.</p>
								<p class="action"><input type="button" value="View Incomplete Grades" onclick="window.location='grades-incomplete.php'" /> - View list of students with incomplete grades.</p>
							</div>
						</div>
					</div>
				</div>
