			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Administration &raquo; Application Type &raquo; Add Type</span> 
							</h1>
							<p class="">Input description of application type below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="type_save" value="Add Type" />
											</td>
										</tr>
									</table>
								</div>
