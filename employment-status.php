...
//::END OF 'CONFIGURATION'
	...
	$statuses = $hnd->GetEmploymentStatuses();
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Employee Administration &raquo; Manage Employee Status</span> 
							</h1>
							<p class="">The list of employee status below will be used to define employees.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='employment.php'" />
									<input type="button" value="Add Employee Status" onclick="window.location='employment-status-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="positions" cellspacing="0" title="">
									<thead>
										<th id="Count">No.</th>
										<th id="Position">Employee Status</th>
										<th id="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
										foreach($statuses as $item){
											...
											if($ctr % 2 == 0){
												...
												echo "<td class=\"Actions\">";
													echo "<a href=\"employment-status-edit.php?id={$item->status_id}\">Edit</a>";
													echo " | ";
													echo "<a href=\"employment-status-process.php?id={$item->status_id}&action=delete\" onclick=\"return confirm('Delete employee status? Click OK to continue.')\">Delete</a>";
												echo "</td>";
											echo "</tr>";
										}
									?>
