			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Section &amp; Schedule Administration &raquo; Sections &raquo; Select College</span>
							</h1>
							...
							<form action="colleges-process.php" method="post">
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
											<td>
												<input type="button" class="button" value="Back" onclick="window.location='schedules.php';"/>
												<input type="button" class="button"  value="Next" onclick="if(getSelectValue('oCollege') > 0){ redirectTo('schedules-section-select-course.php','?cid=' + getSelectValue('oCollege')); } else { alert('Please select a college.') }" />
