...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		$types = $hnd->GetRoomTypes($id);
		
		if(sizeof($types) > 0){
			$type = $types[0];
			$description = $type->description;
		} else {
			$_SESSION['error'] = array("Unknown room type.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Facility Administration &raquo; Manage Room Types &raquo; Edit Type</span> 
							</h1>
							<p class="">Input new description of room type '<?php echo $description; ?>' below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="facilities-room_type-process.php" method="post">
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='facilities-room_type.php';"/>
