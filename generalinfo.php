			...
			<div id="body">
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information</span>
								<?php
									//##### PASS ERROR IF FOUND
									if(isset($success)){
							...
							<p class=""><b></b></p>
							<div id="actions">
								<p class="action"><input type="button" value="Country Listing" onclick="window.location='generalinfo-country.php'" />
								<p class="action"><input type="button" value="Region Listing" onclick="window.location='generalinfo-region.php'" /></p>
								<p class="action"><input type="button" value="Citizenship Listing" onclick="window.location='generalinfo-citizenship.php'" /></p>
								<p class="action"><input type="button" value="Relationship Listing" onclick="window.location='generalinfo-relationship.php'" /></p>
								<p class="action"><input type="button" value="Religion Listing" onclick="window.location='generalinfo-religion.php'" /></p>
							</div>
						</div>
					</div>
				</div>
