								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
											<td>
												...
												<input type="button" class="button" name="cancel" value="Back" onclick="window.location='ecnanif.php'" />
										...
										<?php 
											...
											if(sizeof($records) > 0){
												foreach($records as $item){
													...
													if($ctr % 2 == 0){
														echo "<tr class=\"even\" onclick=\"window.location='ecnanif-p.php?id={$item->student_id}';\">";
													} else {
														echo "<tr class=\"odd\" onclick=\"window.location='ecnanif-p.php?id={$item->student_id}';\">";
													}
														echo "<td>{$ctr}</td>";
