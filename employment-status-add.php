			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Employee Administration &raquo; Manage Employee Status &raquo; Add</span> 
							</h1>
							<p class="">Input description of new employee status below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							<form action="employment-status-process.php" method="post">
								...
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Employee Status</td>
