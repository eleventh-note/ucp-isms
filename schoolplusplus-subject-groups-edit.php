...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		//get groups array
		$groups = $hnd->GetSubjectGroups($id);
		$group = $groups[0];		
	} else {
		$_SESSION['error'] = array("Unknown Subject Group.");
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Subject Administration &raquo; Subject Groups &raquo; Edit Group</span> 
							</h1>
							<p class="">Input new description for group '<b><?php echo $group->description; ?></b>' below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							<form action="schoolplusplus-subject-groups-process.php" method="post">
								...
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Subject Group Description</td>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="group_save" value="Save" />
											</td>
										</tr>
									</table>
								</div>
