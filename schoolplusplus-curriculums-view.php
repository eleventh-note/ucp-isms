					...
					<div class="column" id="column-second">
						<div class="inner">
							...
							<?php 
								if(isset($max_level)){
									echo "<h1>";
										echo "<span class=\"Highlight\">Curriculum Administration &raquo; View Curriculum &raquo; {$college->code} &raquo; {$course->code} SY {$school_year->start} - {$school_year->end}</span>";
									echo "</h1>";
									echo "<div id=\"actions\">";
										echo "<p class=\"action\"><input type=\"button\" value=\"Go Back\" onclick=\"window.location='schoolplusplus-curriculums-bycollege.php?cid={$college->college_id}'\" /> <input type=\"button\" value=\"Edit Curriculum\" onclick=\"window.location='schoolplusplus-curriculums-select-semyear.php?cid={$college->college_id}&cud={$course->course_id}&sy={$sy_id}'\" />
										<input type=\"button\" value=\"Get Report\" onclick=\"window.open('schoolplusplus-curriculums-report.php?cid={$college->college_id}&cud={$course->course_id}&sy={$sy_id}');\" />
										</p>";
									echo "</div>";
