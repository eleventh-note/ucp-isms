			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Section & Schedule Administration » Sections &raquo; Select Course</span>
							</h1>
							...
							<form action="colleges-process.php" method="post">
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
											<td>
												<input type="button" class="button" value="Back" onclick="window.location='schedules-section.php';"/>
												<input type="button" class="button"  value="Next" onclick="if(getSelectValue('oCourse') > 0){
												
												redirectTo('schedules-section-select-curriculum.php?cid=<?php echo $college_id; ?>&cud=', getSelectValue('oCourse'));
