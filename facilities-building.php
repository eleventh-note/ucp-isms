			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Facility Administration &raquo; Manage Buildings</span> 
							</h1>
							<p class="">The list of buildings below will be used to define rooms for subject schedules.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='facilities.php'" />
									<input type="button" value="Add Building" onclick="window.location='facilities-building-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
									...
									<?php 
										...
										foreach($buildings as $item){
											...
											if($ctr % 2 == 0){
												...
												echo "<td>{$item->storeys}</td>";
												echo "<td class=\"Actions\">";
													echo "<a href=\"facilities-building-edit.php?id={$item->building_id}\">Edit</a>";
													echo " | ";
													echo "<a href=\"facilities-building-process.php?id={$item->building_id}&action=delete\" onclick=\"return confirm('Delete building? Click OK to continue.')\">Delete</a>";
												echo "</td>";
											echo "</tr>";
										}
									?>
