...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['cid']) && isset($_GET['id'])){
		...
		$colleges = $hnd_cg->GetColleges($cid);
		$college = $colleges[0];

		$courses = $hnd_co->GetCourses(null, $id);
		
		$course = $courses[0];
		
		$code = $course->code;
		$description = $course->description;
		$_level = $course->max_year_level;
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">College Administration &raquo; <?php echo $college_code; ?> &raquo; Edit Course</span> 
							</h1>
							...
							<form action="colleges-course-process.php" method="post">
								<input type="hidden" name="college" value="<?php echo $cid; ?>" />
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Back" onclick="window.location='colleges-course-view.php?id=<?php echo $id; ?>&cid=<?php echo $cid; ?>';"/>
												<input type="submit" class="button" name="course_save" value="Save" />
											</td>
										</tr>
									</table>
								</div>
