...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		if(sizeof($records) > 0){
			...
			$dict_gen_fees = $hnd_fin->GetMyFees();
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							...
							?>
							<form action="ecnanfi-p-process.php" method="post">
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
											<td>
												...
												<input type="button" class="button" name="cancel" value="Back" onclick="window.location='ecnanif-search.php'" />
