			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Faculty Administration &raquo; Manage Faculty Status &raquo; Add</span> 
							</h1>
							<p class="">Input description of new faculty status below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							<form action="employment-faculty_status-process.php" method="post">
								...
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Faculty Status</td>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="status_save" value="Add" />
											</td>
										</tr>
									</table>
								</div>
