...
//::END OF 'CONFIGURATION'
	...
	if(isset($_POST['search'])){
		...
		$records = $std->SearchSprs($student_number, $keyword);
	}
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Finance Administration &raquo; Student Payments &raquo; Search</span> 
							</h1>
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
											<td>
												...
												<input type="button" class="button" name="cancel" value="Back" onclick="window.location='finance.php'" />
										...
										<?php 
											...
											if(sizeof($records) > 0){
												foreach($records as $item){
													...
													if($ctr % 2 == 0){
														echo "<tr class=\"even\" onclick=\"window.location='finance-student_payments.php?id={$item->student_id}';\">";
													} else {
														echo "<tr class=\"odd\" onclick=\"window.location='finance-student_payments.php?id={$item->student_id}';\">";
													}
														echo "<td>{$ctr}</td>";
														...
														if(isset($backgrounds[$item->student_id])){
															if($backgrounds[$item->student_id]->course != null){
												...
												echo "<td colspan=\"6\">There are no existing Student Permanent Records.</td>";
											}
										?>
