...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		if($id <= 0){
			...
			//# GET INFORMATION
			$records = $std->GetPreAdmissionRecordForEdit($id);
			...
			if(sizeof($records) == 0){
				...
				$_type = $record->application_type;
				$_school_year = $record->school_year;
				$_semester = $record->semester;
				$application_number = $record->application_number;
				$_first = $record->first_choice;
				$_second = $record->second_choice;
				$_third = $record->third_choice;
				$_status = $record->application_status;
				$_passed = $record->course_passed;
					...
					<div class="column" id="column-second">
						<div class="inner">
							...
							<form action="students-preadmission-process.php" method="post">
								<input type="hidden" name="preadmission_id" value="<?php echo $id; ?>" />
								<hr class="form_top"/>
								<div class="table_form">
									...
									<table class="form employee" cellspacing="0">
										...
										<tr class="input">
											<td><input type="text" name="application_number" class="input_employee_number" value="<?php echo $application_number; ?>" readonly=\"readonly\"/></td>
											<td></td>
											<td></td>
											<td></td>
										</tr>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='students-preadmission-view.php?id=<?php echo $id; ?>';"/>
