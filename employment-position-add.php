			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Employee Administration &raquo; Manage Positions &raquo; Add</span> 
							</h1>
							<p class="">Input description of new position below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							<form action="employment-position-process.php" method="post">
								...
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Position</td>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="position_save" value="Add" />
											</td>
										</tr>
									</table>
								</div>
