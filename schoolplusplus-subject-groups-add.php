			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Subject Administration &raquo; Subject Groups &raquo; Add Group</span> 
							</h1>
							<p class="">Input description of new group below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="schoolplusplus-subject-groups-process.php" method="post">
								<hr class="form_top"/>
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New Subject Group</td>
											<td class="input">: <input type="text" name="description" class="input_subject_group" /></td>
										</tr>
									</table>						
									<hr class="form_top"/>
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='schoolplusplus-subject-groups.php';"/>
												<input type="submit" class="button" name="group_save" value="Add" />
											</td>
										</tr>
									</table>
								</div>
