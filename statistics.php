...
//::START OF 'CONFIGURATION'
	...
	require_once(CLASSLIST . "stat.inc.php");
...
//::END OF 'CONFIGURATION'
	...
	$hnd = new Statistics($conn);	
	
	$currentSemesterEnrollees = $hnd->getCurrentSemesterEnrollees();
	$currentSyEnrollees = $hnd->getCurrentSyEnrollees();
	$totalEnrollees = $hnd->getTotalEnrollees();
	$totalPaymentsReceived = $hnd->getTotalPaymentsReceivedRIB();
	$totalPaymentsReceived2 = $hnd->getTotalPaymentsReceivedRIBNON();
	$totalBillings = $hnd->getTotalBillings();
	$totalReceivables = $totalBillings-$totalPaymentsReceived;
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">School Statistics</span>
							</h1>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							<form action="employment-employee-process.php" method="post">
								...
								<div class="table_form">
									...
									<table class="form subject_view" cellspacing="0">
										<tr class="info">
											<td style="width: 200px;"># of enrollees this semester</td><td class="column">: </td>
											<td class="magnify3"><?php echo $currentSemesterEnrollees; ?></td>
											<td></td>
										</tr>
										<tr class="info">
											<td># of enrollees this school year</td>
											<td class="column">:</td>
											<td class="magnify3"><?php echo $currentSyEnrollees; ?></td>
											<td></td>
										</tr>
										<tr class="info">
											<td>overall # of enrollees</td>
											<td class="column">:</td>
											<td class="magnify3"><?php echo $currentSyEnrollees; ?></td>
											<td></td>
										</tr>															
									...
									<h2>MONETARY STATISTICS</h2>
									<table class="form subject_view" cellspacing="0">
										<tr class="info">
											<td style="width: 200px;">Total payments received</td><td class="column">: </td>
											<td class="" title="<?php echo 'Php' . ' ' . number_format($totalPaymentsReceived2,2); ?>"><?php echo 'Php' . ' ' . number_format($totalPaymentsReceived,2); ?></td>
											<td></td>
										</tr>
										<tr class="info">
											<td>Total billings</td>
											<td class="column">:</td>
											<td class=""><?php echo 'Php' . ' ' . number_format($totalBillings,2); ?></td>
											<td></td>
										</tr>
										<tr class="info">
											<td>Total receivables</td>
											<td class="column">:</td>
											<td class=""><b><?php echo 'Php' . ' ' . number_format($totalReceivables,2); ?></b></td>
											<td></td>
										</tr>															
										<tr class="input">
											<td colspan="4"></td>
