...
//::END OF 'CONFIGURATION'
	...
	$citizenships = $hnd->GetCitizenships();
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">General Information &raquo; Citizenship Listing</span> 
							</h1>
							<p class="">Below are list of citizenships used in I-SMS.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='generalinfo.php'" />
									<input type="button" value="Add Citizenship" onclick="window.location='generalinfo-citizenship-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="countries default" cellspacing="0" title="">
									<thead>
										...
										<th class="medium_width">Citizenship</th>
										<th class="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
										if(sizeof($citizenships) > 0){
											foreach($citizenships as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<td class=\"Actions\">";
														echo "<a href=\"generalinfo-citizenship-edit.php?id={$item->citizenship_id}\">Edit</a>";
														echo " | ";
														echo "<a href=\"generalinfo-citizenship-process.php?id={$item->citizenship_id}&action=delete\" onclick=\"return confirm('Delete citizenship from records? Click OK to continue.')\">Delete</a>";
													echo "</td>";
												echo "</tr>";
											}
										} else {
											echo "<td colspan=\"6\">There are no citizenships registered.</td>";
										}
									?>
