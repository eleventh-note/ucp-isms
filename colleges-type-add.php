			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">College Administration &raquo; College Types &raquo; Add Type</span> 
							</h1>
							<p class="">Input description of new college type below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							<form action="colleges-type-process.php" method="post">
								...
								<div class="table_form">
									<table class="form" cellspacing="0">
										<tr>
											<td class="label">New College Type</td>
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												...
												<input type="submit" class="button" name="type_save" value="Add" />
											</td>
										</tr>
									</table>
								</div>
