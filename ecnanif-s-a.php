...
//::END OF 'CONFIGURATION'
	...
	//Dictionaries
	$dict_fee_types = $hnd_fin->GetFeeTypesByKey2();
	$conn->Close();
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							...
							?>
							<form action="ecnanif-s-p.php" method="post">
								<hr class="form_top"/>
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='ecnanif-s.php';"/>
