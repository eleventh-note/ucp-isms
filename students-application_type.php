			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Student Administration &raquo; Application Type</span> 
							</h1>
							<p class="">Below are the application types used to define students during preadmission stage.</p>
							<div id="actions">
								<p class="action">
									<input type="button" value="Go Back" onclick="window.location='students.php'" />
									<input type="button" value="Add Application Type" onclick="window.location='students-application_type-add.php'" />
								</p>
							</div>
							<?php
								//##### PASS ERROR IF FOUND
							...
							<div class="table">
								<table class="colleges" cellspacing="0" title="">
									<thead>
										...
										<th class="college_type">Application Type</th>
										<th class="Actions"></th>
									</thead>
									<?php 
										$ctr = 0;
											...
											foreach($types as $item){
												...
												if($ctr % 2 == 0){
													...
													echo "<td class=\"Actions\">";
														echo "<a href=\"students-application_type-edit.php?id={$item->type_id}\">Edit</a>";
														echo " | ";
														echo "<a href=\"students-application_type-process.php?id={$item->type_id}&action=delete\" onclick=\"return confirm('Delete application type? Click OK to continue.')\">Delete</a>";
													echo "</td>";
												echo "</tr>";
											}
										} else {
											echo "<td colspan=\"6\">There are no application types defined.</td>";
										}
									?>
