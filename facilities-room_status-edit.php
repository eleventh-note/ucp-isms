...
//::END OF 'CONFIGURATION'
	...
	if(isset($_GET['id'])){
		...
		$statuses = $hnd->GetRoomStatuses($id);
		
		if(sizeof($statuses) > 0){
			$status = $statuses[0];
			$description = $status->description;
		} else {
			$_SESSION['error'] = array("Unknown room status.");
			header("Location: facilities-room_status.php");
			exit();
		}
			...
			<div id="body">			
				...
				<div class="content">
					...
					<div class="column" id="column-second">
						<div class="inner">
							<h1>
								<span class="Highlight">Facility Administration &raquo; Manage Room Status &raquo; Edit Status</span> 
							</h1>
							<p class="">Input new description of room status '<?php echo $description; ?>' below.</p>
							<?php
								//##### PASS ERROR IF FOUND
								if(isset($error)){
							...
							?>
							<form action="facilities-room_status-process.php" method="post">
								...
								<div class="table_form">
									...
									<table class="form" cellspacing="0">
										<tr class="button">
											<td colspan="2">
												<input type="button" class="button" value="Cancel" onclick="window.location='facilities-room_status.php';"/>
